    ...
    <main><SiteHeader />
      <article className="article-page">
        ...
        <div className="article-layout">
          ...
          <aside className="article-aside"><p><b>出版資訊</b></p><dl><dt>卷期</dt><dd>第 1 卷第 1 期</dd><dt>出版日期</dt><dd>2026 年 9 月</dd><dt>頁次</dt><dd>{article.pages}</dd>{article.doi && <><dt>DOI</dt><dd>{article.doi}</dd></>}<dt>授權</dt><dd>CC BY-NC 4.0</dd></dl><Button className="download-button" disabled={!article.hasFullText}><Download /> {article.hasFullText ? '下載 PDF 全文' : '全文待上線'}</Button><Button variant="outline"><FileText /> 匯出引用</Button></aside>
        </div>
      </article>
      <SiteFooter />
    </main>
